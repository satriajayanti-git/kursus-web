            ...
            <div class="container-fluid px-2">
                <a class="navbar-brand d-flex align-items-center text-decoration-none" href="#">
                    @if(isset($setting) && $setting->logo)
                        <img src="{{ asset('uploads/settings/'.$setting->logo) }}" alt="Logo" height="35" class="me-2 rounded">
                    @else
            ...
            <div class="col-md-6 col-lg-4">
                <div class="branch-modern-card d-flex flex-column h-100 shadow-sm position-relative">
                    ...
                    <div class="position-relative overflow-hidden">
                        @if($b->foto)
                            <img src="{{ asset('uploads/branches/'.$b->foto) }}" class="branch-frame-img" alt="{{ $b->nama_cabang }}">
                        @else
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-3">
                    <div class="gallery-photo-item shadow-sm">
                        @if($g->foto)
                            <img src="{{ asset('uploads/gallery/'.$g->foto) }}" alt="Galeri" class="w-100 h-100 object-fit-cover">
                        @else
    ...
    <footer class="footer-modern-section">
        <div class="container text-center">
            <div class="d-flex align-items-center justify-content-center mb-4">
                @if(isset($setting) && $setting->logo)
                    <img src="{{ asset('uploads/settings/'.$setting->logo) }}" alt="Logo Footer" height="45" class="me-3 rounded shadow-sm">
                @endif
