<div class="sidebar bg-white border-end d-flex flex-column flex-shrink-0" style="width: 280px; min-width: 280px; height: 100vh; position: sticky; top: 0; left: 0; z-index: 1000;">
    
    <!-- Logo & Header (Konsisten di semua halaman) -->
    ...
    <!-- Menu Navigasi Utama (Struktur lengkap dengan label kategori yang seragam) -->
    ...
    <!-- Tombol Logout (Menempel rapi di bagian bawah) -->
